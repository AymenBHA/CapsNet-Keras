...
if __name__ == "__main__":
    ...
    args = SimpleNamespace(batch_size=100, debug=0, epochs=1, is_training=1, lam_recon=0.392, lr=0.001, 
            num_routing=3, save_dir='./result', shift_fraction=0.1, weights=None, lr_decay=0.9)
